...
function KnowCompliances({ onNavigate }) {
  ...
  const compliances = {
    ...
    PCI_DSS: {
      ...
      keyPoints: [
        "Secure network and systems that store cardholder data",
      ...
      simpleExample: "If your online store accepts credit cards, you must protect that payment information with specific security measures."
    },
    ISO_27001: {
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <div className={`w-12 h-12 bg-gradient-to-r ${getColorClasses(compliance.color)} rounded-2xl flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                  <span className="text-lg">{compliance.icon}</span>
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    <div className={`w-16 h-16 bg-gradient-to-r ${getColorClasses(compliances[selectedCompliance].color)} rounded-3xl flex items-center justify-center text-white shadow-lg`}>
                      <span className="text-2xl">{compliances[selectedCompliance].icon}</span>
                    </div>
                    <div>
