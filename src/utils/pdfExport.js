...
// Import autoTable - this should attach the plugin to jsPDF
try {
  // Try importing the autoTable plugin
  import 'jspdf-autotable';
} catch (error) {
  console.warn('jspdf-autotable plugin not available:', error.message);
}
